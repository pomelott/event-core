...
export default () => {
  ...
  test('[event-core] test function on with bindEvent', () => {
  ...
  // console.log(root)
  test('[event-core] test function getTree', () => {
  ...
  test('[event-core] test trigger return value', () => {
