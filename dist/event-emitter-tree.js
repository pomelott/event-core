...
var EventPipe = (function () {
    function EventPipe(param) {
        ...
        this.conf = ___default['default'].merge(this.conf, param);
    }
...
var EventCore = (function () {
    function EventCore(conf) {
        ...
        this.conf = ___default['default'].merge(this.conf, conf);
    }
    ...
    EventCore.prototype._bindTreeEvent = function (treeArr, callback) {
        ...
        this.root[mountPoint] = ___default['default'].merge(this.root[mountPoint], {
            tree: targetTree
        });
        return returnValue;
    };
    EventCore.prototype._bindItemEvent = function (eventItem, callback) {
        if (!this.root[eventItem] || !this.root[eventItem].pipe) {
            this.root[eventItem] = ___default['default'].merge(this.root[eventItem], {
    ...
    EventCore.prototype._getTargetNodeFromChain = function (eventItem) {
        ...
        return ___default['default'].get(this.root, nodeChain);
    };
    ...
    EventCore.prototype.gc = function (eventItem) {
        try {
            ...
            if (parentChain.length) {
                var parentNode = ___default['default'].get(this.root, parentChain);
                if (parentNode.tree) {
