(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.coreEvent = {}));
    ...
    ***************************************************************************** */
    ...
    var EventPipe = (function () {
        function EventPipe(param) {
            ...
            this.conf = lodash.merge(this.conf, param);
        }
    ...
    var EventCore = (function () {
        function EventCore(conf) {
            ...
            this.conf = lodash.merge(this.conf, conf);
        }
        ...
        EventCore.prototype._bindTreeEvent = function (treeArr, callback) {
            ...
            this.root[mountPoint] = lodash.merge(this.root[mountPoint], {
                tree: targetTree
            });
            return returnValue;
        };
        EventCore.prototype._bindItemEvent = function (eventItem, callback) {
            if (!this.root[eventItem] || !this.root[eventItem].pipe) {
                this.root[eventItem] = lodash.merge(this.root[eventItem], {
        ...
        EventCore.prototype._getTargetNodeFromChain = function (eventItem) {
            ...
            return lodash.get(this.root, nodeChain);
        };
        ...
        EventCore.prototype.gc = function (eventItem) {
            try {
                ...
                if (parentChain.length) {
                    var parentNode = lodash.get(this.root, parentChain);
                    if (parentNode.tree) {
